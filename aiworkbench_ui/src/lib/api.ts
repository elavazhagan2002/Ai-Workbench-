...
async getPublicStats(): Promise<{ domains_count: number; use_cases_count: number }> {
  ...
  async getUseCaseData(useCaseId: string): Promise<UseCaseData[]> {
    return this.request<UseCaseData[]>(`/use-cases/${useCaseId}/data`);
  }
  ...
  async getUseCaseRiskReviews(useCaseId: string): Promise<UseCaseRiskReview[]> {
    return this.request<UseCaseRiskReview[]>(`/use-cases/${useCaseId}/risk-reviews`);
  }
  ...
  async getUseCaseComments(useCaseId: string): Promise<UseCaseComment[]> {
    return this.request<UseCaseComment[]>(`/use-cases/${useCaseId}/comments`);
  }
