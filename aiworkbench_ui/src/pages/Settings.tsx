...
import { ArrowLeft, Save, Plus, Edit2, Trash2, Shield, X, UserX, UserPlus, CheckCircle, Search, Filter } from 'lucide-react';
      ...
      <div className="wb-card-pad">
        ...
        {activeTab === 'users' && (
          <div className="space-y-8">
            ...
            <div className="rounded-lg border border-slate-200/80 bg-white/70 p-3 shadow-sm dark:border-slate-700/80 dark:bg-slate-900/25">
                ...
                <label className="relative min-w-0 flex-1">
                  ...
                  {userFilterSearch ? (
                    <button
                      ...
                      className="absolute right-2 top-1/2 -translate-y-1/2 rounded p-1 text-slate-400 hover:text-slate-700 dark:text-slate-500 dark:hover:text-slate-200"
              ...
              <div className="mt-2 grid grid-cols-1 gap-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6">
                ...
                <UserDirectoryFilterSelect
                  ...
                  searchable={false}
                  options={USER_STATUS_FILTER_OPTIONS.map((status) => ({ value: status, label: status }))}
                />
                <UserDirectoryFilterSelect
                  id="user-filter-organization"
                  label="Organization"
                  value={userFilterOrganization}
                  onChange={setUserFilterOrganization}
                ...
                <UserDirectoryFilterSelect
                  ...
                  onChange={setUserFilterEmailDomain}
                ...
                <div className="mt-3 flex flex-wrap gap-1.5">
                  {activeUserFilterChips.map((chip) => (
                    <button
                      ...
                      className="inline-flex items-center gap-1 rounded-md border border-blue-300 bg-blue-50 px-2 py-1 text-[11px] font-medium text-blue-700 transition hover:bg-blue-100 dark:border-blue-800 dark:bg-blue-950/50 dark:text-blue-300 dark:hover:bg-blue-950/80"
            ...
            <div className="overflow-x-auto rounded-lg border border-slate-200 dark:border-slate-700">
              {(userRowsTotal > usersPerPage || (isUserFilterActive && !isUserSearchLoading && userRowsTotal > 0)) && (
                        ...
                        <div className="mx-auto max-w-md">
                          ...
                          <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">
                            {isUserSearchLoading
                              ...
                              : isUserFilterActive
                              ? 'Try a different keyword, or change the role, status, organization, or domain filters.'
