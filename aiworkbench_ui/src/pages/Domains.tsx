    ...
    <div className="wb-page">
      ...
      {activeDomainId && typeof document !== 'undefined' && createPortal(
        ...
        >
          ...
          <ul className="wb-scroll-slim min-h-0 flex-1 space-y-1.5 overflow-x-clip overflow-y-auto overscroll-contain pr-1">
            {accessLoading && domainAccessList.length === 0 ? (
              ...
              domainAccessList.map((u) => (
                <li key={u.user_id} className="flex min-w-0 items-center gap-2 rounded-lg bg-slate-50 px-2 py-1.5 text-sm dark:bg-slate-700/50">
                  <span className="min-w-0 flex-1 truncate text-slate-900 dark:text-white" title={`${u.user_name} (${u.user_email})`}>
                  ...
                  <button
                    ...
                    disabled={accessLoading}
                    className="shrink-0 rounded p-1 text-red-600 hover:bg-red-50 disabled:opacity-50 dark:hover:bg-red-900/20"
