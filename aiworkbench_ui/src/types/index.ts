...
export interface UseCase {
  ...
  technical_owner?: string | null;  // User ID of technical owner (tech_architect)
  ...
  estimate_owner_name?: string | null;
  estimate_assigned_by_name?: string | null;
  estimate_assigned_dt?: string | null;
  estimate_due_date?: string | null;
  estimate_completed_dt?: string | null;
  roi_data?: unknown;
  roi_owner_name?: string | null;
  roi_assigned_by_name?: string | null;
  roi_assigned_dt?: string | null;
  roi_due_date?: string | null;
  roi_completed_dt?: string | null;
  assessment_owner?: string | null;
  assessment_owner_name?: string | null;
  assessment_assigned_by_name?: string | null;
  assessment_assigned_dt?: string | null;
  assessment_due_date?: string | null;
  assessment_completed_dt?: string | null;
...
export interface SystemConfig {
  ...
  config_data: {
    ...
    llm?: {
      ...
      base_url?: string;
      enabled?: boolean;
      config_source?: 'environment' | 'ui' | string;
      temperature?: number;
      maxTokens?: number;
