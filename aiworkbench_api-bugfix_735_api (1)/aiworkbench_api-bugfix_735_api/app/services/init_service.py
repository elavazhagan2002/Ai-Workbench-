...
def init_roles(db: Session) -> None:
    ...
    for role_data in DEFAULT_ROLES:
        ...
        allowed_perms = set(role_data["permissions"])
        # Remove any permission not in the intended list (sync to DEFAULT_ROLES)
        ...
        for rp in role_perms:
            ...
            if perm and perm.permission_name not in allowed_perms:
                db.delete(rp)
                logger.debug(f"Removed permission {perm.permission_name} from role {role_name}")
