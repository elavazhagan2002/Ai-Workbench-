...
AI_LEADER_ROLE = "ai_leader"

# Seeded roles — rename/delete is forbidden; startup only adds missing perms.
...
# Privileged permissions that only portal_admin may grant on custom roles.
PRIVILEGED_PERMISSIONS = frozenset({"settings_access", "audit_access"})
...
# Keep in sync with ANALYSIS_* assignee eligibility (use_cases assign filters).
TECHNICAL_OWNER_ROLES = ["tech_architect"]
BUSINESS_OWNER_ROLES = ["business_reviewer"]
