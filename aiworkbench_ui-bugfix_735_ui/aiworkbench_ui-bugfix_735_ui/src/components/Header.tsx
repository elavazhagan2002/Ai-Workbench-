import { FileText, Settings, User, LogOut, Moon, Sun, Edit, Bug, X, HelpCircle, KeyRound, BookOpen, LayoutDashboard, Boxes } from 'lucide-react';
...
export default function Header({ onNavigate, currentPage }: HeaderProps) {
  const { user, signOut, hasPermission, updateProfile } = useAuth();
